...
-Path "OU=users,OU=Fullfillment,OU=Departments,DC=corp,DC=zulily,DC=com" `
...
Try{
Set-AdUser $Target -ipPhone $_.Phone
}
Catch {
Write-Host "Missing Phone Number" -foregroundcolor "Red"
Write-Host "Add phone number in if needed to ipPhone field "$Target -foregroundcolor "Yellow"
}
